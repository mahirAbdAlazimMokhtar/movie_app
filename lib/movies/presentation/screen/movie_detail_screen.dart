...
class MovieDetailContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<MovieDetailBloc, MovieDetailState>(
      buildWhen: (previous, current)=>previous.movieDetailsRequestState != current.movieDetailsRequestState,
  ...
  Widget _showRecommendations() {
    return BlocBuilder<MovieDetailBloc, MovieDetailState>(
      //buildWhen: (previous, current)=>previous.recommendationRequestState != current.recommendationRequestState,
      builder: (context, state) {
        return SliverGrid(
